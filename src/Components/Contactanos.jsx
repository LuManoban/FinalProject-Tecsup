            ...
            <div className="ms-5">
                <form className="ms-5" action="#" method="post">
                    ...
                    <div className="ms-5">
                        ...
                        <input className="ms-5" type="text" name="nombre" id="nombre" placeholder="Ingresa tu nombre" required />
                    </div>
                    ...
                    <div className="ms-5">
                        ...
                        <input className="ms-5" type="text" name="apellido" id="apellido" placeholder="Ingresa tu apellido" required />
                    </div>
                    ...
                    <div className="ms-5">
                        ...
                        <input className="ms-5" type="email" name="email" id="email" placeholder="Ingresa tu correo" required />
                    </div>
                    ...
                    <div className="ms-5">
                        ...
                        <input className="ms-2" type="text" name="telefono" id="telefono" placeholder="Ingresa tu teléfono" />
                    </div>
